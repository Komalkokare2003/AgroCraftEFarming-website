          ...
          if ($resultCheck > 0) {
               while ($rows = mysqli_fetch_array($run_query)) {
                    ...
                    echo "<div class='container'>
                                   <div class='row'>
                                        <div class='col-md-6' style='padding:8px; margin-top:18px;'>
                                             <img src='../Admin/product_images/$product_image' class='rounded mx-auto d-block bord' height='350px' width='500px' >      
                                             <br>
                                             <div class='row'>
                                                  <div class='col-md-7'>
