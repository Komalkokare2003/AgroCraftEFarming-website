...
<head>
     ...
     <script>
          function  taluka() {
               var a = document.getElementById('taluka').value;
               if (a === 'Malshiras') {
                    var array = ['Select Village', 'Akluj', 'Nimgaon','Paniv','Velapur'];
               } else if (a === 'Pandharpur') {
                    var array = ['Select Village', 'Bardi', 'Gardi', 'Palshi', 'Sangavi', 'Tarapur'];
               } else if (a === 'Barshi') {
                    var array = ['Select Village', 'Belgaon', 'Balewadi', 'Devgaon', 'Gholvewadi', 'Pimpri'];
               } else if (a === 'Madha') {
                    var array = ['Select Village', 'Dahiwali', 'Ghatane', 'Lahu', 'Loni', 'Palwan'];
               } else if (a === 'Sangola') {
                    var array = ['Select Village', 'Akola', 'Balvadi', 'Narale', 'Rajuri' ];
               } else if (a === 'Akkalkot') {
                    var array = ['Select Village', 'Andewadi', 'Arali', 'Borjoan', 'Chincholi', 'Jainapur' ];
               } else if (a === 'Karmala') {
                    var array = ['Select Village', 'Jeur', 'Kem', 'Korti', 'Takali', 'Wangi-1'];
               }   //check

               } else if (a === 'PUNJAB') {
                    var array = ['Select village ', 'Gurdaspur', 'Amritsar', 'Kapurthala', 'Jalandhar', 'Hoshiarpur', 'Nawanshahr *', 'Rupnagar', 'Fatehgarh Sahib *', 'Ludhiana', 'Moga *', 'Firozpur', 'Muktsar *', 'Faridkot', 'Bathinda', 'Mansa *', 'Sangrur', 'Patiala'];
               } else if (a === 'NAGALAND') {
                    var array = ['Select village', 'Mon', 'Tuensang', 'Mokokchung', 'Zunheboto', 'Wokha', 'Dimapur *', 'Kohima', 'Phek', 'MANIPUR', 'Senapati', 'Tamenglong', 'Churachandpur', 'Bishnupur', 'Thoubal', 'Imphal West', 'Imphal East *', 'Ukhrul', 'Chandel'];
               } else if (a === 'TRIPURA') {
                    var array = ['Select village', 'West Tripura ', 'South Tripura ', 'Dhalai  *', 'North Tripura '];
               } else if (a === 'MIZORAM') {
                    var array = ['Select village', 'Mamit *', 'Kolasib *', 'Aizawl', 'Champhai *', 'Serchhip *', 'Lunglei', 'Lawngtlai', 'Saiha *'];
               } else if (a === 'ARUNACHAL PRADESH') {
                    var array = ['Select village', 'Tawang', 'West Kameng', 'East Kameng', 'Papum Pare *', 'Lower Subansiri', 'Upper Subansiri', 'West Siang', 'East Siang', 'Upper Siang *', 'Dibang Valley', 'Lohit', 'Changlang', 'Tirap'];
               } else if (a === 'CHANDIGARH') {
                    var array = ['Select village', 'Chandigarh'];
               } else if (a === 'DELHI') {
                    var array = ['Select village', 'North West   *', 'North   *', 'North East   *', 'East   *', 'New Delhi', 'Central  *', 'West   *', 'South West   *', 'South  *'];
               } else if (a === 'DELHI') {
                    var array = ['Select village', 'Uttarkashi', 'Chamoli', 'Rudraprayag *', 'Tehri Garhwal', 'Dehradun', 'Garhwal', 'Pithoragarh', 'Bageshwar', 'Almora', 'Champawat', 'Nainital', 'Udham Singh Nagar *', 'Hardwar'];
               }
               ...
               document.getElementById('village').innerHTML = string;
...
<div class=" flex-row-reverse right ">
    ...
    <div class="text-success  login">Login</div>
     ...
     <form action="" method="post">
          <div class="container">
               <div class="row   p-2">
                    ...
                    <select class="p-2 shadow-lg" id="taluka" name="talukaInput" onchange="taluka()" tabindex="1" style="border-radius: 6px; margin-right:  200px; border-color:#FFD700 ">
                    ...
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 village">
                         <!-- <div class="dropdown">
                         <button class="btn btn-green mybtn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <b>Village</b>
                         </button>
                    ...
                    <select class="p-2 ml-5 shadow-lg" name="villageInput" id="village" style="border-radius: 6px; border-color: #FFD700 ">
     ...
     <?php
     if (isset($_POST['go'])) {
          $villageInput = $_POST['villageInput'];
          $talukaInput = $_POST['talukaInput'];
          echo $talukaInput;
          echo "<br>";
          echo $villageInput;

          if ($talukaInput != '0' && $villageInput == 'Select village') {
               echo "<script>window.open('TalukaSearch.php?taluka=$talukaInput','_self')</script>";
          } else {
               echo "<script>window.open('VillageSearch.php?village=$villageInput','_self')</script>";
          }
     }
