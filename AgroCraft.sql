...
CREATE TABLE `editproduct` (
  ...
  `product_stock`int(16) NOT NULL,
  `product_MRP` int(16) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `editproduct`
--

INSERT INTO `editproduct` (`product_title`, `product_type`, `product_stock`, `product_MRP`) VALUES
...
INSERT INTO `payments` (`name`, `email`,`card_number`,`product_code`, `amount`) VALUES
...
ALTER TABLE `editproduct`
  MODIFY `product_stock` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
--
